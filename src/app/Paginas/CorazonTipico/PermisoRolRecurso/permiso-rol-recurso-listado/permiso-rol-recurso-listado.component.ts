...
import { PermisoRolRecursoServicio } from '../../../../Servicios/CorazonTipico/PermisoRolRecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarCorazonTipicoComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { PermisoRolRecursoCrearCorazonTipicoComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-CorazonTipico',
  imports: [FormsModule, CommonModule, SidebarCorazonTipicoComponent, PermisoRolRecursoCrearCorazonTipicoComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoCorazonTipicoComponent {
