...
import { PermisoRolRecurso } from '../.././../../Modelos/ModeloCorazonTipico/PermisoRolRecurso';
...
@Component({
  selector: 'app-permiso-rol-recurso-crear-CorazonTipico',
...
export class PermisoRolRecursoCrearCorazonTipicoComponent {
