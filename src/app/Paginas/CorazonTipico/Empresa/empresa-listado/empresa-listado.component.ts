...
import { EmpresaCrearCorazonTipicoComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-CorazonTipico',
  imports: [FormsModule, CommonModule, SidebarCorazonTipicoComponent, EmpresaCrearCorazonTipicoComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoCorazonTipicoComponent {
