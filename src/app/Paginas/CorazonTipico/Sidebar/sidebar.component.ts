...
@Component({
  selector: 'app-sidebar-CorazonTipico',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarCorazonTipicoComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaCorazonTipico: string = Entorno.NombreEmpresaCorazonTipico;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioCorazonTipico) {
