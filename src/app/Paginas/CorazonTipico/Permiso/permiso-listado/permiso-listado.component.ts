...
import { PermisoServicio } from '../../../../Servicios/CorazonTipico/PermisoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarCorazonTipicoComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { Permiso } from '../.././../../Modelos/ModeloCorazonTipico/Permiso';
import { AlertaServicio } from '../../../../Servicios/Alerta-Servicio';
import { PermisoCrearCorazonTipicoComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-CorazonTipico',
  imports: [FormsModule, CommonModule, SidebarCorazonTipicoComponent, PermisoCrearCorazonTipicoComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoCorazonTipicoComponent {
