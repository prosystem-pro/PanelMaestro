...
import { UsuarioCrearCorazonTipicoComponent } from '../usuario-crear/usuario-crear.component';
...
@Component({
  selector: 'app-usuario-listado-CorazonTipico',
  imports: [FormsModule, CommonModule, SidebarCorazonTipicoComponent, UsuarioCrearCorazonTipicoComponent, SpinnerGlobalComponent],
  templateUrl: './usuario-listado.component.html',
  styleUrl: './usuario-listado.component.css'
})
export class UsuarioListadoCorazonTipicoComponent {
