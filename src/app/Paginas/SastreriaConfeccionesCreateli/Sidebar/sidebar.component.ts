...
@Component({
  selector: 'app-sidebar-SastreriaConfeccionesCreateli',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarSastreriaConfeccionesCreateliComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaSastreriaConfeccionesCreateli: string = Entorno.NombreEmpresaSastreriaConfeccionesCreateli;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioSastreriaConfeccionesCreateli) {
