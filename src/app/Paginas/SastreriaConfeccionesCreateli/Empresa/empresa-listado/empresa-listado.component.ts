...
import { EmpresaCrearSastreriaConfeccionesCreateliComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-SastreriaConfeccionesCreateli',
  imports: [FormsModule, CommonModule, SidebarSastreriaConfeccionesCreateliComponent, EmpresaCrearSastreriaConfeccionesCreateliComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoSastreriaConfeccionesCreateliComponent {
