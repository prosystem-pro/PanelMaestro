...
import { PermisoRolRecursoCrearSastreriaConfeccionesCreateliComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-SastreriaConfeccionesCreateli',
  imports: [FormsModule, CommonModule, SidebarSastreriaConfeccionesCreateliComponent, PermisoRolRecursoCrearSastreriaConfeccionesCreateliComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoSastreriaConfeccionesCreateliComponent {
