...
import { RecursoServicio } from '../../../../Servicios/SastreriaConfeccionesCreateli/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarSastreriaConfeccionesCreateliComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearSastreriaConfeccionesCreateliComponent } from '../recurso-crear/recurso-crear.component';
...
@Component({
  selector: 'app-recurso-listado-SastreriaConfeccionesCreateli',
  imports: [FormsModule, CommonModule, SidebarSastreriaConfeccionesCreateliComponent, RecursoCrearSastreriaConfeccionesCreateliComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoSastreriaConfeccionesCreateliComponent {
