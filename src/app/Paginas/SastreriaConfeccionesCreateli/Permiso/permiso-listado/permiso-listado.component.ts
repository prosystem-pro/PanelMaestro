...
import { PermisoServicio } from '../../../../Servicios/SastreriaConfeccionesCreateli/PermisoServicio';
...
import { PermisoCrearSastreriaConfeccionesCreateliComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-SastreriaConfeccionesCreateli',
  imports: [FormsModule, CommonModule, SidebarSastreriaConfeccionesCreateliComponent, PermisoCrearSastreriaConfeccionesCreateliComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoSastreriaConfeccionesCreateliComponent {
