...
import { RolCrearSastreriaConfeccionesCreateliComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-SastreriaConfeccionesCreateli',
  imports: [FormsModule, CommonModule, SidebarSastreriaConfeccionesCreateliComponent, RolCrearSastreriaConfeccionesCreateliComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoSastreriaConfeccionesCreateliComponent {
