...
import { EmpresaServicio } from '../../../Servicios/SastreriaConfeccionesCreateli/EmpresaServicio';
import { SidebarSastreriaConfeccionesCreateliComponent } from '../Sidebar/sidebar.component';
import { SpinnerGlobalComponent } from '../../../Componentes/spinner-global/spinner-global.component';

@Component({
  selector: 'app-pago-SastreriaConfeccionesCreateli',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarSastreriaConfeccionesCreateliComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoSastreriaConfeccionesCreateliComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoSastreriaConfeccionesCreateli;
  Empresa = Entorno.NombreEmpresaSastreriaConfeccionesCreateli;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaSastreriaConfeccionesCreateli}`;
  private Url = `${Entorno.ApiUrlSastreriaConfeccionesCreateli}`;

  constructor(
    private pagoServicio: PagoServicioSastreriaConfeccionesCreateli,
