...
import { RecursoServicio } from '../../../../Servicios/RestauranteKaski/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarRestauranteKaskiComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearRestauranteKaskiComponent } from '../recurso-crear/recurso-crear.component';
import { Recurso } from '../.././../../Modelos/ModeloRestauranteKaski/Recurso';
import { AlertaServicio } from '../../../../Servicios/Alerta-Servicio';

declare var bootstrap: any;

@Component({
  selector: 'app-recurso-listado-RestauranteKaski',
  imports: [FormsModule, CommonModule, SidebarRestauranteKaskiComponent, RecursoCrearRestauranteKaskiComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoRestauranteKaskiComponent {
