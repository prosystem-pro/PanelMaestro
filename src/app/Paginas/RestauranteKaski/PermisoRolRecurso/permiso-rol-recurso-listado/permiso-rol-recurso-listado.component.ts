...
import { PermisoRolRecursoCrearRestauranteKaskiComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
export class PermisoRolRecursoListadoRestauranteKaskiComponent {
