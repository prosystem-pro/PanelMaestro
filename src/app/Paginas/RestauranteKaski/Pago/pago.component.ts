...
import { PagoServicio } from '../../../Servicios/RestauranteKaski/PagoServicio';
...
@Component({
  selector: 'app-pago-RestauranteKaski',
  imports: [FormsModule, CommonModule, ReactiveFormsModule,SidebarRestauranteKaskiComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoRestauranteKaskiComponent implements OnInit {
  LogoEmpresa = Entorno.LogoRestauranteKaski;
  Empresa = Entorno.NombreEmpresaRestauranteKaski;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaRestauranteKaski}`;
  private Url = `${Entorno.ApiUrlRestauranteKaski}`;
