...
import { PagoServicio } from '../../../Servicios/PromesaDeDios/PagoServicio';
...
export class PagoPromesaDeDiosComponent implements OnInit {
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaPromesaDeDios}`;
  private Url = `${Entorno.ApiUrlPromesaDeDios}`;
