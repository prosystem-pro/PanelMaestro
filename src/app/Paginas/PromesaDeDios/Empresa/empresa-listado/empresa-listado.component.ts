...
import { EmpresaCrearPromesaDeDiosComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-PromesaDeDios',
  imports: [FormsModule, CommonModule, SidebarPromesaDeDiosComponent, EmpresaCrearPromesaDeDiosComponent, SpinnerGlobalComponent],
