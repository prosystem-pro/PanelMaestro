...
import { PermisoRolRecursoServicio } from '../../../../Servicios/PromesaDeDios/PermisoRolRecursoServicio';
import { PermisoRolRecurso } from '../.././../../Modelos/ModeloPromesaDeDios/PermisoRolRecurso';
...
@Component({
  selector: 'app-permiso-rol-recurso-crear-PromesaDeDios',
...
export class PermisoRolRecursoCrearPromesaDeDiosComponent {
