...
import { UsuarioCrearPromesaDeDiosComponent } from '../usuario-crear/usuario-crear.component';
...
@Component({
  selector: 'app-usuario-listado-PromesaDeDios',
  imports: [FormsModule, CommonModule, SidebarPromesaDeDiosComponent, UsuarioCrearPromesaDeDiosComponent, SpinnerGlobalComponent],
  templateUrl: './usuario-listado.component.html',
  styleUrl: './usuario-listado.component.css'
})
export class UsuarioListadoPromesaDeDiosComponent {
