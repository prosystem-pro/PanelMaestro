...
@Component({
  selector: 'app-sidebar-ConstructoraMorgan',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarConstructoraMorganComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaConstructoraMorgan: string = Entorno.NombreEmpresaConstructoraMorgan;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioConstructoraMorgan) {
