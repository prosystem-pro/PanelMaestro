...
import { RolCrearConstructoraMorganComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-ConstructoraMorgan',
  imports: [FormsModule, CommonModule, SidebarConstructoraMorganComponent, RolCrearConstructoraMorganComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoConstructoraMorganComponent {
