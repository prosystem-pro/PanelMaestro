...
import { PermisoRolRecurso } from '../.././../../Modelos/ModeloConstructoraMorgan/PermisoRolRecurso';
...
@Component({
  selector: 'app-permiso-rol-recurso-crear-ConstructoraMorgan',
...
export class PermisoRolRecursoCrearConstructoraMorganComponent {
