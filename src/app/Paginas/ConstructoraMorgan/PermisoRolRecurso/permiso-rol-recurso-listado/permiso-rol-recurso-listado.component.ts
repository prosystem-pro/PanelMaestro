...
import { PermisoRolRecursoServicio } from '../../../../Servicios/ConstructoraMorgan/PermisoRolRecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarConstructoraMorganComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { PermisoRolRecursoCrearConstructoraMorganComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-ConstructoraMorgan',
  imports: [FormsModule, CommonModule, SidebarConstructoraMorganComponent, PermisoRolRecursoCrearConstructoraMorganComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoConstructoraMorganComponent {
