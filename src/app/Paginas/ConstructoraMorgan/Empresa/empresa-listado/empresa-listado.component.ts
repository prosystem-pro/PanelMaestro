...
import { EmpresaCrearConstructoraMorganComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-ConstructoraMorgan',
  imports: [FormsModule, CommonModule, SidebarConstructoraMorganComponent, EmpresaCrearConstructoraMorganComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoConstructoraMorganComponent {
