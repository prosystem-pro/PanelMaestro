...
import { RecursoServicio } from '../../../../Servicios/ConstructoraMorgan/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarConstructoraMorganComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearConstructoraMorganComponent } from '../recurso-crear/recurso-crear.component';
import { Recurso } from '../.././../../Modelos/ModeloConstructoraMorgan/Recurso';
...
@Component({
  selector: 'app-recurso-listado-ConstructoraMorgan',
  imports: [FormsModule, CommonModule, SidebarConstructoraMorganComponent, RecursoCrearConstructoraMorganComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoConstructoraMorganComponent {
