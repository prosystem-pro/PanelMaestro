...
@Component({
  selector: 'app-pago-ConstructoraMorgan',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarConstructoraMorganComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoConstructoraMorganComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoConstructoraMorgan;
  Empresa = Entorno.NombreEmpresaConstructoraMorgan;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaConstructoraMorgan}`;
  private Url = `${Entorno.ApiUrlConstructoraMorgan}`;

  constructor(
    private pagoServicio: PagoServicioConstructoraMorgan,
