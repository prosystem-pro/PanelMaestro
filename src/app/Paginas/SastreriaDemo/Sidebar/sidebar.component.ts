...
@Component({
  selector: 'app-sidebar-SastreriaDemo',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarSastreriaDemoComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaSastreriaDemo: string = Entorno.NombreEmpresaSastreriaDemo;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioSastreriaDemo) {
