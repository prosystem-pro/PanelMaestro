...
import { EmpresaServicio } from '../../../../Servicios/SastreriaDemo/EmpresaServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarSastreriaDemoComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { EmpresaCrearSastreriaDemoComponent } from '../empresa-crear/empresa-crear.component';
import { Empresa } from '../.././../../Modelos/ModeloSastreriaDemo/Empresa';
import { AlertaServicio } from '../../../../Servicios/Alerta-Servicio';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;
@Component({
  selector: 'app-empresa-listado-SastreriaDemo',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoComponent, EmpresaCrearSastreriaDemoComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoSastreriaDemoComponent {
