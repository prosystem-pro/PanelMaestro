...
import { PermisoRolRecursoCrearSastreriaDemoComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-SastreriaDemo',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoComponent, PermisoRolRecursoCrearSastreriaDemoComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoSastreriaDemoComponent {
