...
import { RolCrearSastreriaDemoComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-SastreriaDemo',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoComponent, RolCrearSastreriaDemoComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoSastreriaDemoComponent {
