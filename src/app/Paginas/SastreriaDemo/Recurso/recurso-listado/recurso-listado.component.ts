...
import { RecursoServicio } from '../../../../Servicios/SastreriaDemo/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarSastreriaDemoComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearSastreriaDemoComponent } from '../recurso-crear/recurso-crear.component';
...
@Component({
  selector: 'app-recurso-listado-SastreriaDemo',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoComponent, RecursoCrearSastreriaDemoComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoSastreriaDemoComponent {
