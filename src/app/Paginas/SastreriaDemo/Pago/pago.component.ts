...
@Component({
  selector: 'app-pago-SastreriaDemo',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarSastreriaDemoComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoSastreriaDemoComponent implements OnInit {
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaSastreriaDemo}`;
  private Url = `${Entorno.ApiUrlSastreriaDemo}`;

  constructor(
    private pagoServicio: PagoServicioSastreriaDemo,
