...
import { PermisoServicio } from '../../../../Servicios/SastreriaDemo/PermisoServicio';
...
import { PermisoCrearSastreriaDemoComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-SastreriaDemo',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoComponent, PermisoCrearSastreriaDemoComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoSastreriaDemoComponent {
