...
import { EmpresaCrearAgendaComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-Agenda',
  imports: [FormsModule, CommonModule, SidebarAgendaComponent, EmpresaCrearAgendaComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoAgendaComponent {
