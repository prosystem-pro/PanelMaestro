...
import { PermisoServicio } from '../../../../Servicios/Agenda/PermisoServicio';
...
import { PermisoCrearAgendaComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-Agenda',
  imports: [FormsModule, CommonModule, SidebarAgendaComponent, PermisoCrearAgendaComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoAgendaComponent {
