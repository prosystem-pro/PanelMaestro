...
@Component({
  selector: 'app-pago-Agenda',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarAgendaComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoAgendaComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoAgenda;
  Empresa = Entorno.NombreEmpresaAgenda;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaAgenda}`;
  private Url = `${Entorno.ApiUrlAgenda}`;

  constructor(
    private pagoServicio: PagoServicioAgenda,
