...
import { PermisoRolRecursoServicio } from '../../../../Servicios/Agenda/PermisoRolRecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarAgendaComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { PermisoRolRecursoCrearAgendaComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-Agenda',
  imports: [FormsModule, CommonModule, SidebarAgendaComponent, PermisoRolRecursoCrearAgendaComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoAgendaComponent {
