...
import { RolCrearAgendaComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-Agenda',
  imports: [FormsModule, CommonModule, SidebarAgendaComponent, RolCrearAgendaComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoAgendaComponent {
