...
@Component({
  selector: 'app-pago-ChocosDeLaAbuela',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarChocosDeLaAbuelaComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoChocosDeLaAbuelaComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoChocosDeLaAbuela;
  Empresa = Entorno.NombreEmpresaChocosDeLaAbuela;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaChocosDeLaAbuela}`;
  private Url = `${Entorno.ApiUrlChocosDeLaAbuela}`;

  constructor(
    private pagoServicio: PagoServicioChocosDeLaAbuela,
