...
import { EmpresaCrearChocosDeLaAbuelaComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-ChocosDeLaAbuela',
  imports: [FormsModule, CommonModule, SidebarChocosDeLaAbuelaComponent, EmpresaCrearChocosDeLaAbuelaComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoChocosDeLaAbuelaComponent {
