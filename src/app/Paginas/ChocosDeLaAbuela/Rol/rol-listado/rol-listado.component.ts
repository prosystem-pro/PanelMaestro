...
import { RolCrearChocosDeLaAbuelaComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-ChocosDeLaAbuela',
  imports: [FormsModule, CommonModule, SidebarChocosDeLaAbuelaComponent, RolCrearChocosDeLaAbuelaComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoChocosDeLaAbuelaComponent {
