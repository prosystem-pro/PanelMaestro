...
import { RecursoServicio } from '../../../../Servicios/ChocosDeLaAbuela/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarChocosDeLaAbuelaComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearChocosDeLaAbuelaComponent } from '../recurso-crear/recurso-crear.component';
import { Recurso } from '../.././../../Modelos/ModeloChocosDeLaAbuela/Recurso';
...
@Component({
  selector: 'app-recurso-listado-ChocosDeLaAbuela',
  imports: [FormsModule, CommonModule, SidebarChocosDeLaAbuelaComponent, RecursoCrearChocosDeLaAbuelaComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoChocosDeLaAbuelaComponent {
