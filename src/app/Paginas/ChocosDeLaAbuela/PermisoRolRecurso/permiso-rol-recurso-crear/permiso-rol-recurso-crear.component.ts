...
import { PermisoRolRecurso } from '../.././../../Modelos/ModeloChocosDeLaAbuela/PermisoRolRecurso';
...
@Component({
  selector: 'app-permiso-rol-recurso-crear-ChocosDeLaAbuela',
...
export class PermisoRolRecursoCrearChocosDeLaAbuelaComponent {
