...
import { PermisoRolRecursoServicio } from '../../../../Servicios/ChocosDeLaAbuela/PermisoRolRecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarChocosDeLaAbuelaComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { PermisoRolRecursoCrearChocosDeLaAbuelaComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-ChocosDeLaAbuela',
  imports: [FormsModule, CommonModule, SidebarChocosDeLaAbuelaComponent, PermisoRolRecursoCrearChocosDeLaAbuelaComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoChocosDeLaAbuelaComponent {
