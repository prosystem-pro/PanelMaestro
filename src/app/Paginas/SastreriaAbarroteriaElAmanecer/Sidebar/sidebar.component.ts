...
@Component({
  selector: 'app-sidebar-SastreriaAbarroteriaElAmanecer',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarSastreriaAbarroteriaElAmanecerComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaSastreriaAbarroteriaElAmanecer: string = Entorno.NombreEmpresaSastreriaAbarroteriaElAmanecer;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioSastreriaAbarroteriaElAmanecer) {
