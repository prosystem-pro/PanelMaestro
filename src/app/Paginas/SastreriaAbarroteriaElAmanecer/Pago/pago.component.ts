...
import { EmpresaServicio } from '../../../Servicios/SastreriaAbarroteriaElAmanecer/EmpresaServicio';
import { SidebarSastreriaAbarroteriaElAmanecerComponent } from '../Sidebar/sidebar.component';
import { SpinnerGlobalComponent } from '../../../Componentes/spinner-global/spinner-global.component';

@Component({
  selector: 'app-pago-SastreriaAbarroteriaElAmanecer',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarSastreriaAbarroteriaElAmanecerComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoSastreriaAbarroteriaElAmanecerComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoSastreriaAbarroteriaElAmanecer;
  Empresa = Entorno.NombreEmpresaSastreriaAbarroteriaElAmanecer;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaSastreriaAbarroteriaElAmanecer}`;
  private Url = `${Entorno.ApiUrlSastreriaAbarroteriaElAmanecer}`;

  constructor(
    private pagoServicio: PagoServicioSastreriaAbarroteriaElAmanecer,
