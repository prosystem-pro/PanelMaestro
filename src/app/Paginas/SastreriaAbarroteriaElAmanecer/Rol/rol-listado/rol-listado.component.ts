...
import { RolCrearSastreriaAbarroteriaElAmanecerComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-SastreriaAbarroteriaElAmanecer',
  imports: [FormsModule, CommonModule, SidebarSastreriaAbarroteriaElAmanecerComponent, RolCrearSastreriaAbarroteriaElAmanecerComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoSastreriaAbarroteriaElAmanecerComponent {
