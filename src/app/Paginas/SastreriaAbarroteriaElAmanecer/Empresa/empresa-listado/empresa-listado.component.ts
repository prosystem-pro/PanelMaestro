...
import { EmpresaCrearSastreriaAbarroteriaElAmanecerComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-SastreriaAbarroteriaElAmanecer',
  imports: [FormsModule, CommonModule, SidebarSastreriaAbarroteriaElAmanecerComponent, EmpresaCrearSastreriaAbarroteriaElAmanecerComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoSastreriaAbarroteriaElAmanecerComponent {
