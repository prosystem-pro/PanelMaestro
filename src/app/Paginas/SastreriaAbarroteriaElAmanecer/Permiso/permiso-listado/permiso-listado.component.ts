...
import { PermisoServicio } from '../../../../Servicios/SastreriaAbarroteriaElAmanecer/PermisoServicio';
...
import { PermisoCrearSastreriaAbarroteriaElAmanecerComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-SastreriaAbarroteriaElAmanecer',
  imports: [FormsModule, CommonModule, SidebarSastreriaAbarroteriaElAmanecerComponent, PermisoCrearSastreriaAbarroteriaElAmanecerComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoSastreriaAbarroteriaElAmanecerComponent {
