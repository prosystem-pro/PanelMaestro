...
import { PermisoRolRecursoCrearSastreriaAbarroteriaElAmanecerComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-SastreriaAbarroteriaElAmanecer',
  imports: [FormsModule, CommonModule, SidebarSastreriaAbarroteriaElAmanecerComponent, PermisoRolRecursoCrearSastreriaAbarroteriaElAmanecerComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoSastreriaAbarroteriaElAmanecerComponent {
