...
import { RecursoServicio } from '../../../../Servicios/SastreriaAbarroteriaElAmanecer/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarSastreriaAbarroteriaElAmanecerComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearSastreriaAbarroteriaElAmanecerComponent } from '../recurso-crear/recurso-crear.component';
...
@Component({
  selector: 'app-recurso-listado-SastreriaAbarroteriaElAmanecer',
  imports: [FormsModule, CommonModule, SidebarSastreriaAbarroteriaElAmanecerComponent, RecursoCrearSastreriaAbarroteriaElAmanecerComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoSastreriaAbarroteriaElAmanecerComponent {
