...
import { PermisoRolRecursoCrearSastreriaAnderTrajesYUniformesComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-SastreriaAnderTrajesYUniformes',
  imports: [FormsModule, CommonModule, SidebarSastreriaAnderTrajesYUniformesComponent, PermisoRolRecursoCrearSastreriaAnderTrajesYUniformesComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoSastreriaAnderTrajesYUniformesComponent {
