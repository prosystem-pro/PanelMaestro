...
import { PermisoServicio } from '../../../../Servicios/SastreriaAnderTrajesYUniformes/PermisoServicio';
...
import { PermisoCrearSastreriaAnderTrajesYUniformesComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-SastreriaAnderTrajesYUniformes',
  imports: [FormsModule, CommonModule, SidebarSastreriaAnderTrajesYUniformesComponent, PermisoCrearSastreriaAnderTrajesYUniformesComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoSastreriaAnderTrajesYUniformesComponent {
