...
import { RecursoServicio } from '../../../../Servicios/SastreriaAnderTrajesYUniformes/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarSastreriaAnderTrajesYUniformesComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearSastreriaAnderTrajesYUniformesComponent } from '../recurso-crear/recurso-crear.component';
...
@Component({
  selector: 'app-recurso-listado-SastreriaAnderTrajesYUniformes',
  imports: [FormsModule, CommonModule, SidebarSastreriaAnderTrajesYUniformesComponent, RecursoCrearSastreriaAnderTrajesYUniformesComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoSastreriaAnderTrajesYUniformesComponent {
