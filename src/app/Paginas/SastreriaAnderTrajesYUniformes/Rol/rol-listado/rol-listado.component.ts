...
import { RolCrearSastreriaAnderTrajesYUniformesComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-SastreriaAnderTrajesYUniformes',
  imports: [FormsModule, CommonModule, SidebarSastreriaAnderTrajesYUniformesComponent, RolCrearSastreriaAnderTrajesYUniformesComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoSastreriaAnderTrajesYUniformesComponent {
