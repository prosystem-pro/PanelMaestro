...
import { EmpresaCrearSastreriaAnderTrajesYUniformesComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-SastreriaAnderTrajesYUniformes',
  imports: [FormsModule, CommonModule, SidebarSastreriaAnderTrajesYUniformesComponent, EmpresaCrearSastreriaAnderTrajesYUniformesComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoSastreriaAnderTrajesYUniformesComponent {
