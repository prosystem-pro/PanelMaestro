...
@Component({
  selector: 'app-sidebar-SastreriaAnderTrajesYUniformes',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarSastreriaAnderTrajesYUniformesComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaSastreriaAnderTrajesYUniformes: string = Entorno.NombreEmpresaSastreriaAnderTrajesYUniformes;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioSastreriaAnderTrajesYUniformes) {
