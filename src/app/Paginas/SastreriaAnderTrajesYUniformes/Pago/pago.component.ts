...
import { EmpresaServicio } from '../../../Servicios/SastreriaAnderTrajesYUniformes/EmpresaServicio';
import { SidebarSastreriaAnderTrajesYUniformesComponent } from '../Sidebar/sidebar.component';
import { SpinnerGlobalComponent } from '../../../Componentes/spinner-global/spinner-global.component';

@Component({
  selector: 'app-pago-SastreriaAnderTrajesYUniformes',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarSastreriaAnderTrajesYUniformesComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoSastreriaAnderTrajesYUniformesComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoSastreriaAnderTrajesYUniformes;
  Empresa = Entorno.NombreEmpresaSastreriaAnderTrajesYUniformes;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaSastreriaAnderTrajesYUniformes}`;
  private Url = `${Entorno.ApiUrlSastreriaAnderTrajesYUniformes}`;

  constructor(
    private pagoServicio: PagoServicioSastreriaAnderTrajesYUniformes,
