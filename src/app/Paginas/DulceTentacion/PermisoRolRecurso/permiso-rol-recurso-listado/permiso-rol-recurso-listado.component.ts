...
import { PermisoRolRecursoServicio } from '../../../../Servicios/DulceTentacion/PermisoRolRecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarDulceTentacionComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { PermisoRolRecursoCrearDulceTentacionComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-DulceTentacion',
  imports: [FormsModule, CommonModule, SidebarDulceTentacionComponent, PermisoRolRecursoCrearDulceTentacionComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoDulceTentacionComponent {
