...
@Component({
  selector: 'app-sidebar-DulceTentacion',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarDulceTentacionComponent {
  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaDulceTentacion: string = Entorno.NombreEmpresaDulceTentacion;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioDulceTentacion) {
