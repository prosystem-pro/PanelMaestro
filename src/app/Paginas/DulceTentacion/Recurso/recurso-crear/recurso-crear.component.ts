...
import { RecursoServicio } from '../../../../Servicios/DulceTentacion/RecursoServicio';
import { AlertaServicio } from '../../../../Servicios/Alerta-Servicio';
import { CommonModule } from '@angular/common';

@Component({
  selector: 'app-recurso-crear-DulceTentacion',
  imports: [FormsModule, CommonModule],
  templateUrl: './recurso-crear.component.html',
  styleUrl: './recurso-crear.component.css'
})
export class RecursoCrearDulceTentacionComponent {
