...
import { PagoServicio } from '../../../Servicios/DulceTentacion/PagoServicio';
...
@Component({
  selector: 'app-pago-DulceTentacion',
  imports: [FormsModule, CommonModule, ReactiveFormsModule,SidebarDulceTentacionComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoDulceTentacionComponent implements OnInit {
  LogoEmpresa = Entorno.LogoDulceTentacion;
  Empresa = Entorno.NombreEmpresaDulceTentacion;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaDulceTentacion}`;
  private Url = `${Entorno.ApiUrlDulceTentacion}`;
