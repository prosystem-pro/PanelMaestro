...
import { RolCrearRestauranteElBistroComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-RestauranteElBistro',
  imports: [FormsModule, CommonModule, SidebarRestauranteElBistroComponent, RolCrearRestauranteElBistroComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoRestauranteElBistroComponent {
