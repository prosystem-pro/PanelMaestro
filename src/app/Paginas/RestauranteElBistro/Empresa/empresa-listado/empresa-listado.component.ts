...
import { EmpresaCrearRestauranteElBistroComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-RestauranteElBistro',
  imports: [FormsModule, CommonModule, SidebarRestauranteElBistroComponent, EmpresaCrearRestauranteElBistroComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoRestauranteElBistroComponent {
