...
import { PermisoServicio } from '../../../../Servicios/RestauranteElBistro/PermisoServicio';
...
import { PermisoCrearRestauranteElBistroComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-RestauranteElBistro',
  imports: [FormsModule, CommonModule, SidebarRestauranteElBistroComponent, PermisoCrearRestauranteElBistroComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoRestauranteElBistroComponent {
