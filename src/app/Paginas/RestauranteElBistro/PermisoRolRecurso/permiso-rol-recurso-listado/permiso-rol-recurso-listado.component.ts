...
import { PermisoRolRecursoCrearRestauranteElBistroComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-RestauranteElBistro',
  imports: [FormsModule, CommonModule, SidebarRestauranteElBistroComponent, PermisoRolRecursoCrearRestauranteElBistroComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoRestauranteElBistroComponent {
