...
import { EmpresaServicio } from '../../../Servicios/RestauranteElBistro/EmpresaServicio';
import { SidebarRestauranteElBistroComponent } from '../Sidebar/sidebar.component';
import { SpinnerGlobalComponent } from '../../../Componentes/spinner-global/spinner-global.component';

@Component({
  selector: 'app-pago-RestauranteElBistro',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarRestauranteElBistroComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoRestauranteElBistroComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoRestauranteElBistro;
  Empresa = Entorno.NombreEmpresaRestauranteElBistro;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaRestauranteElBistro}`;
  private Url = `${Entorno.ApiUrlRestauranteElBistro}`;

  constructor(
    private pagoServicio: PagoServicioRestauranteElBistro,
