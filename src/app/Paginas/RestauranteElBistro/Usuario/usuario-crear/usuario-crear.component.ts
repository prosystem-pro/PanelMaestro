...
import { Empresa } from '../.././../../Modelos/ModeloRestauranteElBistro/Empresa';
...
@Component({
  selector: 'app-usuario-crear-RestauranteElBistro',
  imports: [FormsModule, CommonModule, SpinnerGlobalComponent],
  templateUrl: './usuario-crear.component.html',
  styleUrl: './usuario-crear.component.css'
})
export class UsuarioCrearRestauranteElBistroComponent {
