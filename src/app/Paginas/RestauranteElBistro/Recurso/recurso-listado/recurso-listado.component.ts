...
import { RecursoServicio } from '../../../../Servicios/RestauranteElBistro/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarRestauranteElBistroComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearRestauranteElBistroComponent } from '../recurso-crear/recurso-crear.component';
...
@Component({
  selector: 'app-recurso-listado-RestauranteElBistro',
  imports: [FormsModule, CommonModule, SidebarRestauranteElBistroComponent, RecursoCrearRestauranteElBistroComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoRestauranteElBistroComponent {
