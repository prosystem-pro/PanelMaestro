...
import { PermisoRolRecursoCrearFamilyShopComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-FamilyShop',
  imports: [FormsModule, CommonModule, SidebarFamilyShopComponent, PermisoRolRecursoCrearFamilyShopComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoFamilyShopComponent {
