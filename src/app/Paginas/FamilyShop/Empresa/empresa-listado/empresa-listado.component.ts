...
import { EmpresaCrearFamilyShopComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-FamilyShop',
  imports: [FormsModule, CommonModule, SidebarFamilyShopComponent, EmpresaCrearFamilyShopComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoFamilyShopComponent {
