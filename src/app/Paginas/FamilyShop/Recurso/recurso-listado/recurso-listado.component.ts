...
import { RecursoServicio } from '../../../../Servicios/FamilyShop/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarFamilyShopComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearFamilyShopComponent } from '../recurso-crear/recurso-crear.component';
...
@Component({
  selector: 'app-recurso-listado-FamilyShop',
  imports: [FormsModule, CommonModule, SidebarFamilyShopComponent, RecursoCrearFamilyShopComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoFamilyShopComponent {
