...
@Component({
  selector: 'app-pago-FamilyShop',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarFamilyShopComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoFamilyShopComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoFamilyShop;
  Empresa = Entorno.NombreEmpresaFamilyShop;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaFamilyShop}`;
  private Url = `${Entorno.ApiUrlFamilyShop}`;

  constructor(
    private pagoServicio: PagoServicioFamilyShop,
