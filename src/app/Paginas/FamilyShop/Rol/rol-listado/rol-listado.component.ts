...
import { RolCrearFamilyShopComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-FamilyShop',
  imports: [FormsModule, CommonModule, SidebarFamilyShopComponent, RolCrearFamilyShopComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoFamilyShopComponent {
