...
@Component({
  selector: 'app-sidebar-FamilyShop',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarFamilyShopComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaFamilyShop: string = Entorno.NombreEmpresaFamilyShop;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioFamilyShop) {
