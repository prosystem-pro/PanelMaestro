...
import { PermisoServicio } from '../../../../Servicios/FamilyShop/PermisoServicio';
...
import { PermisoCrearFamilyShopComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-FamilyShop',
  imports: [FormsModule, CommonModule, SidebarFamilyShopComponent, PermisoCrearFamilyShopComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoFamilyShopComponent {
