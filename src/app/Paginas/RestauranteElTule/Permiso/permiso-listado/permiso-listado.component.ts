...
import { PermisoServicio } from '../../../../Servicios/RestauranteElTule/PermisoServicio';
...
import { PermisoCrearRestauranteElTuleComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-RestauranteElTule',
  imports: [FormsModule, CommonModule, SidebarRestauranteElTuleComponent, PermisoCrearRestauranteElTuleComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoRestauranteElTuleComponent {
