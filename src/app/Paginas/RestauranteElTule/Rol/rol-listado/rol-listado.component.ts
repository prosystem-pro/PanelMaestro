...
import { RolCrearRestauranteElTuleComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-RestauranteElTule',
  imports: [FormsModule, CommonModule, SidebarRestauranteElTuleComponent, RolCrearRestauranteElTuleComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoRestauranteElTuleComponent {
