...
import { UsuarioServicio } from '../../../../Servicios/RestauranteElTule/UsuarioServicio';
import { RolServicio } from '../../../../Servicios/RestauranteElTule/RolServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarRestauranteElTuleComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { Usuario } from '../.././../../Modelos/ModeloRestauranteElTule/Usuario';
import { Rol } from '../.././../../Modelos/ModeloRestauranteElTule/Rol';
import { AlertaServicio } from '../../../../Servicios/Alerta-Servicio';
import { UsuarioCrearRestauranteElTuleComponent } from '../usuario-crear/usuario-crear.component';
...
@Component({
  selector: 'app-usuario-listado-RestauranteElTule',
  imports: [FormsModule, CommonModule, SidebarRestauranteElTuleComponent, UsuarioCrearRestauranteElTuleComponent, SpinnerGlobalComponent],
  templateUrl: './usuario-listado.component.html',
  styleUrl: './usuario-listado.component.css'
})
export class UsuarioListadoRestauranteElTuleComponent {
