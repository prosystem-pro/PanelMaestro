...
@Component({
  selector: 'app-pago-RestauranteElTule',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarRestauranteElTuleComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoRestauranteElTuleComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoRestauranteElTule;
  Empresa = Entorno.NombreEmpresaRestauranteElTule;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaRestauranteElTule}`;
  private Url = `${Entorno.ApiUrlRestauranteElTule}`;

  constructor(
    private pagoServicio: PagoServicioRestauranteElTule,
