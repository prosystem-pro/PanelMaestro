...
@Component({
  selector: 'app-sidebar-RestauranteElTule',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarRestauranteElTuleComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaRestauranteElTule: string = Entorno.NombreEmpresaRestauranteElTule;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioRestauranteElTule) {
