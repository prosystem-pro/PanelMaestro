...
import { RecursoServicio } from '../../../../Servicios/RestauranteElTule/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarRestauranteElTuleComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearRestauranteElTuleComponent } from '../recurso-crear/recurso-crear.component';
...
@Component({
  selector: 'app-recurso-listado-RestauranteElTule',
  imports: [FormsModule, CommonModule, SidebarRestauranteElTuleComponent, RecursoCrearRestauranteElTuleComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoRestauranteElTuleComponent {
