...
import { PermisoRolRecursoCrearCafeJuanAnaComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-CafeJuanAna',
  imports: [FormsModule, CommonModule, SidebarCafeJuanAnaComponent, PermisoRolRecursoCrearCafeJuanAnaComponent],
