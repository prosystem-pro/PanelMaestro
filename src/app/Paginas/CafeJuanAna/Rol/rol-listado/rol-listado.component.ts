...
import { RolCrearCafeJuanAnaComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  ...
  imports: [FormsModule, CommonModule, SidebarCafeJuanAnaComponent, RolCrearCafeJuanAnaComponent, SpinnerGlobalComponent],
