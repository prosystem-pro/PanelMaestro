...
import { EmpresaCrearSastreriaDemoOficialComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-SastreriaDemoOficial',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoOficialComponent, EmpresaCrearSastreriaDemoOficialComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoSastreriaDemoOficialComponent {
