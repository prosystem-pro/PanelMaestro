...
import { RecursoServicio } from '../../../../Servicios/SastreriaDemoOficial/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarSastreriaDemoOficialComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearSastreriaDemoOficialComponent } from '../recurso-crear/recurso-crear.component';
...
@Component({
  selector: 'app-recurso-listado-SastreriaDemoOficial',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoOficialComponent, RecursoCrearSastreriaDemoOficialComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoSastreriaDemoOficialComponent {
