...
@Component({
  selector: 'app-sidebar-SastreriaDemoOficial',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarSastreriaDemoOficialComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaSastreriaDemoOficial: string = Entorno.NombreEmpresaSastreriaDemoOficial;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioSastreriaDemoOficial) {
