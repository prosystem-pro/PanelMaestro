...
import { PermisoRolRecursoCrearSastreriaDemoOficialComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-SastreriaDemoOficial',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoOficialComponent, PermisoRolRecursoCrearSastreriaDemoOficialComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoSastreriaDemoOficialComponent {
