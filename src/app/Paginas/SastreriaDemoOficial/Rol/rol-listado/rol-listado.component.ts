...
import { RolCrearSastreriaDemoOficialComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-SastreriaDemoOficial',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoOficialComponent, RolCrearSastreriaDemoOficialComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoSastreriaDemoOficialComponent {
