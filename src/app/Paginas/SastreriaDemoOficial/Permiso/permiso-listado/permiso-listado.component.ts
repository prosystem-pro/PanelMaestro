...
import { PermisoServicio } from '../../../../Servicios/SastreriaDemoOficial/PermisoServicio';
...
import { PermisoCrearSastreriaDemoOficialComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-SastreriaDemoOficial',
  imports: [FormsModule, CommonModule, SidebarSastreriaDemoOficialComponent, PermisoCrearSastreriaDemoOficialComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoSastreriaDemoOficialComponent {
