...
import { Empresa } from '../.././../../Modelos/ModeloAjachelTravelAgency/Empresa';
...
@Component({
  selector: 'app-usuario-crear-AjachelTravelAgency',
  imports: [FormsModule, CommonModule, SpinnerGlobalComponent],
  templateUrl: './usuario-crear.component.html',
  styleUrl: './usuario-crear.component.css'
})
export class UsuarioCrearAjachelTravelAgencyComponent {
