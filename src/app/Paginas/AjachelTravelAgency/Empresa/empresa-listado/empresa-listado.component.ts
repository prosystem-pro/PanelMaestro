...
import { EmpresaCrearAjachelTravelAgencyComponent } from '../empresa-crear/empresa-crear.component';
...
@Component({
  selector: 'app-empresa-listado-AjachelTravelAgency',
  imports: [FormsModule, CommonModule, SidebarAjachelTravelAgencyComponent, EmpresaCrearAjachelTravelAgencyComponent, SpinnerGlobalComponent],
  templateUrl: './empresa-listado.component.html',
  styleUrl: './empresa-listado.component.css'
})
export class EmpresaListadoAjachelTravelAgencyComponent {
