...
@Component({
  selector: 'app-sidebar-AjachelTravelAgency',
  imports: [CommonModule],
  templateUrl: './sidebar.component.html',
  styleUrl: './sidebar.component.css'
})
export class SidebarAjachelTravelAgencyComponent {

  SidebarVisible = true;
  EsMovil = false;
  NombreEmpresaAjachelTravelAgency: string = Entorno.NombreEmpresaAjachelTravelAgency;
  constructor(private router: Router, private elemento: ElementRef,  private LoginServicio: LoginServicioAjachelTravelAgency) {
