...
import { RecursoServicio } from '../../../../Servicios/AjachelTravelAgency/RecursoServicio';
import { FormsModule } from '@angular/forms';
import { CommonModule } from '@angular/common';
import { SidebarAjachelTravelAgencyComponent } from "../../Sidebar/sidebar.component";
import { Entorno } from '../../../../Entornos/Entorno';
import { Router } from '@angular/router';
import { RecursoCrearAjachelTravelAgencyComponent } from '../recurso-crear/recurso-crear.component';
...
@Component({
  selector: 'app-recurso-listado-AjachelTravelAgency',
  imports: [FormsModule, CommonModule, SidebarAjachelTravelAgencyComponent, RecursoCrearAjachelTravelAgencyComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoAjachelTravelAgencyComponent {
