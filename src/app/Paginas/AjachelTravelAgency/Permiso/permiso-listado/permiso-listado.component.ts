...
import { PermisoServicio } from '../../../../Servicios/AjachelTravelAgency/PermisoServicio';
...
import { PermisoCrearAjachelTravelAgencyComponent } from '../permiso-crear/permiso-crear.component';
import { SpinnerGlobalComponent } from '../../../../Componentes/spinner-global/spinner-global.component';

declare var bootstrap: any;

@Component({
  selector: 'app-permiso-listado-AjachelTravelAgency',
  imports: [FormsModule, CommonModule, SidebarAjachelTravelAgencyComponent, PermisoCrearAjachelTravelAgencyComponent, SpinnerGlobalComponent],
  templateUrl: './permiso-listado.component.html',
  styleUrl: './permiso-listado.component.css'
})
export class PermisoListadoAjachelTravelAgencyComponent {
