...
import { PermisoRolRecursoCrearAjachelTravelAgencyComponent } from '../permiso-rol-recurso-crear/permiso-rol-recurso-crear.component';
...
@Component({
  standalone: true,
  selector: 'app-permiso-rol-recurso-listado-AjachelTravelAgency',
  imports: [FormsModule, CommonModule, SidebarAjachelTravelAgencyComponent, PermisoRolRecursoCrearAjachelTravelAgencyComponent],
  templateUrl: './permiso-rol-recurso-listado.component.html',
  styleUrl: './permiso-rol-recurso-listado.component.css'
})
export class PermisoRolRecursoListadoAjachelTravelAgencyComponent {
