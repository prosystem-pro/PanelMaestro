...
import { RolCrearAjachelTravelAgencyComponent } from '../rol-crear/rol-crear.component';
...
@Component({
  selector: 'app-rol-listado-AjachelTravelAgency',
  imports: [FormsModule, CommonModule, SidebarAjachelTravelAgencyComponent, RolCrearAjachelTravelAgencyComponent, SpinnerGlobalComponent],
  templateUrl: './rol-listado.component.html',
  styleUrl: './rol-listado.component.css'
})
export class RolListadoAjachelTravelAgencyComponent {
