...
import { EmpresaServicio } from '../../../Servicios/AjachelTravelAgency/EmpresaServicio';
import { SidebarAjachelTravelAgencyComponent } from '../Sidebar/sidebar.component';
import { SpinnerGlobalComponent } from '../../../Componentes/spinner-global/spinner-global.component';

@Component({
  selector: 'app-pago-AjachelTravelAgency',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarAjachelTravelAgencyComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoAjachelTravelAgencyComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoAjachelTravelAgency;
  Empresa = Entorno.NombreEmpresaAjachelTravelAgency;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaAjachelTravelAgency}`;
  private Url = `${Entorno.ApiUrlAjachelTravelAgency}`;

  constructor(
    private pagoServicio: PagoServicioAjachelTravelAgency,
