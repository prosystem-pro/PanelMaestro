...
@Component({
  selector: 'app-pago-Vendedor',
  imports: [FormsModule, CommonModule, ReactiveFormsModule, SidebarVendedorComponent, SpinnerGlobalComponent],
  templateUrl: './pago.component.html',
  styleUrl: './pago.component.css'
})
export class PagoVendedorComponent implements OnInit {

  Spinner: boolean = false;
  LogoEmpresa = Entorno.LogoVendedor;
  Empresa = Entorno.NombreEmpresaVendedor;
  ...
  private NombreEmpresa = `${Entorno.NombreEmpresaVendedor}`;
  private Url = `${Entorno.ApiUrlVendedor}`;

  constructor(
    private pagoServicio: PagoServicioVendedor,
