...
import { RecursoCrearVendedorComponent } from '../recurso-crear/recurso-crear.component';
import { Recurso } from '../.././../../Modelos/ModeloVendedor/Recurso';
...
@Component({
  selector: 'app-recurso-listado-Vendedor',
  imports: [FormsModule, CommonModule, SidebarVendedorComponent, RecursoCrearVendedorComponent, SpinnerGlobalComponent],
  templateUrl: './recurso-listado.component.html',
  styleUrl: './recurso-listado.component.css'
})
export class RecursoListadoVendedorComponent {
