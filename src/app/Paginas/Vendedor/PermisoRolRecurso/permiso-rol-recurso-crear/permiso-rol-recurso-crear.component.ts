...
import { PermisoRolRecurso } from '../.././../../Modelos/ModeloVendedor/PermisoRolRecurso';
...
@Component({
  selector: 'app-permiso-rol-recurso-crear-Vendedor',
...
export class PermisoRolRecursoCrearVendedorComponent {
