...
import { UsuarioCrearVendedorComponent } from '../usuario-crear/usuario-crear.component';
...
@Component({
  selector: 'app-usuario-listado-Vendedor',
  imports: [FormsModule, CommonModule, SidebarVendedorComponent, UsuarioCrearVendedorComponent, SpinnerGlobalComponent],
  templateUrl: './usuario-listado.component.html',
  styleUrl: './usuario-listado.component.css'
})
export class UsuarioListadoVendedorComponent {
