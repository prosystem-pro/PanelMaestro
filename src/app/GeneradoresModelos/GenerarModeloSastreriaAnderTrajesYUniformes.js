...
const apiUrl = Entorno.ApiUrlGenerarModeloSastreriaAnderTrajesYUniformes;
const modelsDirectory = path.resolve(__dirname, '../Modelos/ModeloSastreriaAnderTrajesYUniformes/');
