...
export class PagoServicioSastreriaAnderTrajesYUniformes {
  private Url = `${Entorno.ApiUrlSastreriaAnderTrajesYUniformes}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlSastreriaAnderTrajesYUniformes}resumen-general-pagos/${anio}`);
  }
