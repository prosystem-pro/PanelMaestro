...
export class RecursoServicio {
  private Url = `${Entorno.ApiUrlSastreriaAnderTrajesYUniformes}recurso`;
  ...
  ObtenerPermisosDisponibles(): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlSastreriaAnderTrajesYUniformes}permisos-disponibles`);
  }
