...
export class PagoServicioSastreriaDemo {
  private Url = `${Entorno.ApiUrlSastreriaDemo}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlSastreriaDemo}resumen-general-pagos/${anio}`);
  }
