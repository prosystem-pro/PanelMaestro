...
export class PagoServicioSastreriaConfeccionesCreateli {
  private Url = `${Entorno.ApiUrlSastreriaConfeccionesCreateli}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlSastreriaConfeccionesCreateli}resumen-general-pagos/${anio}`);
  }
