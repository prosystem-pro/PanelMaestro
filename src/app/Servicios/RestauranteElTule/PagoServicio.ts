...
export class PagoServicioRestauranteElTule {
  private Url = `${Entorno.ApiUrlRestauranteElTule}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlRestauranteElTule}resumen-general-pagos/${anio}`);
  }
