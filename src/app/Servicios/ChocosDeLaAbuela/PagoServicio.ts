...
export class PagoServicioChocosDeLaAbuela {
  private Url = `${Entorno.ApiUrlChocosDeLaAbuela}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlChocosDeLaAbuela}resumen-general-pagos/${anio}`);
  }
