...
export class PagoServicioSastreriaDemoOficial {
  private Url = `${Entorno.ApiUrlSastreriaDemoOficial}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlSastreriaDemoOficial}resumen-general-pagos/${anio}`);
  }
