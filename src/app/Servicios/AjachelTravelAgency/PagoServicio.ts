...
export class PagoServicioAjachelTravelAgency {
  private Url = `${Entorno.ApiUrlAjachelTravelAgency}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlAjachelTravelAgency}resumen-general-pagos/${anio}`);
  }
