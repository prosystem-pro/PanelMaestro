...
export class PagoServicioRestauranteElBistro {
  private Url = `${Entorno.ApiUrlRestauranteElBistro}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlRestauranteElBistro}resumen-general-pagos/${anio}`);
  }
