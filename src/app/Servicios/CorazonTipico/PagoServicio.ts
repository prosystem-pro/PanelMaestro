...
export class PagoServicioCorazonTipico {
  private Url = `${Entorno.ApiUrlCorazonTipico}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlCorazonTipico}resumen-general-pagos/${anio}`);
  }
