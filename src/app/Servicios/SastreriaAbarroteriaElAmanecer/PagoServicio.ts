...
export class PagoServicioSastreriaAbarroteriaElAmanecer {
  private Url = `${Entorno.ApiUrlSastreriaAbarroteriaElAmanecer}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlSastreriaAbarroteriaElAmanecer}resumen-general-pagos/${anio}`);
  }
