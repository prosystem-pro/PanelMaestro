...
export class RecursoServicio {
  private Url = `${Entorno.ApiUrlSastreriaAbarroteriaElAmanecer}recurso`;
  ...
  ObtenerPermisosDisponibles(): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlSastreriaAbarroteriaElAmanecer}permisos-disponibles`);
  }
