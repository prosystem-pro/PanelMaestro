...
export class PagoServicioConstructoraMorgan {
  private Url = `${Entorno.ApiUrlConstructoraMorgan}pago`;
  ...
  ObtenerResumenGeneralPagos(anio: number): Observable<any> {
    return this.http.get(`${Entorno.ApiUrlConstructoraMorgan}resumen-general-pagos/${anio}`);
  }
